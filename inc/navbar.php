<nav class="navbar navbar-expand-lg navbar-light bg-danger">
  <div class="container-fluid">
    <a class="navbar-brand text-white" href="index.php">Lamda Academy</a>
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link text-white" href="#"><i class="fa fa-user"></i>Student</a>
        </li>
        <li class="nav-item dropdown">
          ...
          <i class="fa fa-graduation-cap" aria-hidden="true"></i>Other stuff
          </a>
          <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
            ...
            <li><a class="dropdown-item" href="edu-facilities.php">Education Facilities</a></li>
            <li><a class="dropdown-item" href="student-corner.php">Student's Corner</a></li>
          </ul>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="contact-us.php" tabindex="-1" ><i class="fa fa-envelope"></i>Contact Us</a>
        </li>
      </ul>

      <ul class="navbar-nav ml-auto ">
        <li class="nav-item">
          <a class="nav-link text-white" href="#"> <i class="fa fa-facebook" aria-hidden="true"></i> </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white" href="#"> <i class="fa fa-youtube" aria-hidden="true"></i> </a>
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle text-white" href="#" id="navbarScrollingDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            <i class="fa fa-cog"></i>
